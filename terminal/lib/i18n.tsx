...
export const LEX: Record<string, [string, string]> = {
  ...
  leadersAbsent: ["Couldn't load Flow Leaders", "暂时无法加载资金流领涨榜"],
  leadersAbsentSub: ["This panel couldn't reach its data. Retry in a moment.", "此面板暂时无法获取数据，请稍后重试。"],
  flowRetry: ["Retry", "重试"],
  ...
  radarAbsent: ["Couldn't load Leader Radar", "暂时无法加载领涨雷达"],
  radarAbsentSub: ["This panel couldn't reach its data. Retry in a moment.", "此面板暂时无法获取数据，请稍后重试。"],
