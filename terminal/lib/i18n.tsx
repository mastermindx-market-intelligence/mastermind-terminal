...
export const LEX: Record<string, [string, string]> = {
  ...
  shrSub: ["Lists you shared, and lists other people shared with you.", "您共享出去的清单，以及他人共享给您的清单。"],
  shrMineHead: ["Lists you shared", "您共享的清单"],
  shrYouShared: ["You shared this list", "您已共享此清单"],
  shrShareCta: ["Share a list", "共享清单"],
  shrPickList: ["Choose one of your lists", "选择您的一份清单"],
  shrAccountLabel: ["Their account ID", "对方的账户 ID"],
  shrAccountHint: ["Ask them to open Settings, then Account, and copy their User ID to you.", "请对方打开“设置”中的“账户”，复制其用户 ID 发给您。"],
  ...
  shrMineEmpty: ["You have not shared a list with anyone yet.", "您还没有向任何人共享清单。"],
  shrTheirsHead: ["Shared with you", "共享给您的"],
  shrSharedWithYouBy: ["Shared with you by another Mastermind account", "由另一个 Mastermind 账户共享给您"],
  shrReadOnlyBadge: ["Read only", "仅可查看"],
  shrOpenList: ["View list", "查看清单"],
  shrCloseList: ["Hide list", "收起清单"],
  shrSymbolsWord: ["symbols", "个标的"],
  shrTheirsEmpty: ["No one has shared a list with you yet.", "还没有人向您共享清单。"],
  shrNoLongerShared: ["This list is no longer shared with you.", "此清单已不再共享给您。"],
  ...
  shrReadFailed: ["We could not read your shared lists just now.", "我们暂时无法读取您的共享清单。"],
