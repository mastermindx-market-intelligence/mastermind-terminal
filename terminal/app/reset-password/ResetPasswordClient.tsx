...
export default function ResetPasswordClient({ recoveryAllowed }: { recoveryAllowed: boolean }) {
  const t = useT();
  const router = useRouter();
  const [phase, setPhase] = useState<Phase>(() => recoveryAllowed ? "checking" : "invalid");
