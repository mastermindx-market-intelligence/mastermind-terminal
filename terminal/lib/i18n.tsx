...
export const LEX: Record<string, [string, string]> = {
  ...
  accCalibWithheld: ["Not enough settled calls yet ({n} of 30).", "已核对的判断还不够（{n}／30）。"],
  ...
  accDetEpisodes: ["Checked groups", "已核对的判断组"],
  accDetClaims: ["Calls written down", "写下的判断"],
  accDetUnscorable: ["Could not be checked", "无法核对"],
  ...
  accDetHitsOf1: ["{hits} of 1 checked call landed.", "已核对的 1 条判断中，有 {hits} 条落在正确一边。"],
  accDetBrierN: ["Brier {value} over {n} resolved calls.", "按 {n} 条已核对判断计算，Brier 分数 {value}。"],
  accDetBrierN1: ["Brier {value} over 1 resolved call.", "按 1 条已核对判断计算，Brier 分数 {value}。"],
