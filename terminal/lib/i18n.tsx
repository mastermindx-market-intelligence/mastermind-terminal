...
export const LEX: Record<string, [string, string]> = {
  ...
  mtfTip: ["Precision multi-timeframe — four views matched to the current chart horizon", "精准多周期 — 根据当前图表周期匹配四个视图"],
  mtfUnavailableTip: ["Precision multi-timeframe is not available from this chart timeframe", "当前图表周期无法使用精准多周期"],
