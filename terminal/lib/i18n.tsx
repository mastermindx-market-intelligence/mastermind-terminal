...
export const LEX: Record<string, [string, string]> = {
  ...
  acsCurrentPwPh: ["Enter your current password", "输入您的当前密码"],
  ...
  acsPwNoPassword: ["You signed in without a password, so there is nothing to change here.", "您登录时未设置密码，因此这里没有可更改的内容。"],
