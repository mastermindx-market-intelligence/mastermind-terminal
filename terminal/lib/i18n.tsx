...
export const LEX: Record<string, [string, string]> = {
  ...
  acsTeam: ["Team", "团队"],
  acsTeamSub: ["The people who share this team with you.", "与您共享此团队的成员。"],
  ...
  acsTeamLeaveAsk: ["Leave this team? You will lose access to everything the team shares.", "确定退出该团队吗？您将无法再访问团队共享的任何内容。"],
