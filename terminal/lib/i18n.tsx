...
export const LEX: Record<string, [string, string]> = {
  ...
  wlDragSelected: ["Drag {n} selected tickers", "拖动已选择的 {n} 个代码"],
  wlMovingSymbols: ["Moving {n}", "正在移动 {n} 个"],
  wlMoveHere: ["Move {n} here", "将 {n} 个移动到这里"],
  wlA11yPickedSelection: ["Picked up {n}-ticker selection.", "已提起包含 {n} 个代码的选择。"],
  wlA11yMoveBefore: ["Move {n}-ticker selection before {target}.", "将包含 {n} 个代码的选择移动到 {target} 之前。"],
  wlA11yMoveAfter: ["Move {n}-ticker selection after {target}.", "将包含 {n} 个代码的选择移动到 {target} 之后。"],
  wlA11yMoveSectionStart: ["Move {n}-ticker selection to the start of {target}.", "将包含 {n} 个代码的选择移动到 {target} 分区开头。"],
  wlA11yMoveRoot: ["Move {n}-ticker selection above all sections.", "将包含 {n} 个代码的选择移动到所有分区之前。"],
  wlA11yDroppedSelection: ["Dropped {n}-ticker selection.", "已放下包含 {n} 个代码的选择。"],
  wlA11yCancelledSelection: ["Move cancelled; {n}-ticker selection stayed in place.", "已取消移动；{n} 个代码保持原位。"],
  wlA11yPickedSection: ["Picked up section {section}.", "已提起 {section} 分区。"],
  wlA11yMoveSectionBlock: ["Move section {section} near {target}.", "将 {section} 分区移动到 {target} 附近。"],
  wlA11yDroppedSection: ["Dropped section {section}.", "已放下 {section} 分区。"],
  wlA11yCancelledSection: ["Move cancelled; section {section} stayed in place.", "已取消移动；{section} 分区保持原位。"],
  wlA11yInstructions: ["Press Space to pick up. When multiple tickers are selected, any selected ticker lifts the whole selection. Use Up and Down to choose a row or section start. Press Space to drop or Escape to cancel.", "按空格键提起。选择多个代码后，提起任一已选代码都会移动整个选择。使用上下方向键选择行或分区开头。按空格键放下，或按 Escape 取消。"],
  ...
  colVol: ["Vol", "成交量"],
  colVolGtOi: ["Volume above open interest", "成交量高于未平仓量"],
  // Vol tab
  ...
  acsAlertOn: ["On", "开"],
  acsAlertOff: ["Off", "关"],
  acsAlertCats: ["What we email you about", "邮件提醒的内容"],
  acsAlertCatHold: ["A position I hold moves on real news", "我持有的仓位因真实消息出现变动"],
  acsAlertCatThes: ["A market view I'm watching starts or ends", "我关注的市场观点开始或结束"],
  acsAlertTz: ["Time zone", "时区"],
  ...
  acsTeam: ["Team", "团队"],
  acsTeamSub: ["The people who share this team with you.", "与你共享此团队的成员。"],
  acsTeamPeople: ["People on this team", "团队成员"],
  acsRoleOwner: ["Owner", "所有者"],
  acsRoleAdmin: ["Administrator", "管理员"],
  acsRoleMember: ["Member", "成员"],
  acsRoleOwnerWhat: ["Created this team. Can do everything. Cannot leave or be removed.", "创建了该团队。拥有全部权限，不能退出，也不能被移除。"],
  acsRoleUnknown: ["Role not recognised", "无法识别的角色"],
  acsRoleAdminWhat: ["Can invite people, remove members and change team settings.", "可以邀请他人、移除成员并更改团队设置。"],
  acsRoleMemberWhat: ["Can see the team and everything it shares. Cannot invite or remove people.", "可以查看团队及其共享的所有内容。不能邀请或移除他人。"],
  acsTeamWhatEach: ["What each role can do", "各角色的权限说明"],
  acsTeamYou: ["You", "你"],
  acsTeamJoined: ["Joined", "加入时间"],
  acsMakeAdmin: ["Make an administrator", "设为管理员"],
  acsMakeMember: ["Make a member", "设为成员"],
  acsTeamRemove: ["Remove from team", "移出团队"],
  acsTeamLeave: ["Leave this team", "退出该团队"],
  acsOwnerLocked: ["The owner created this team. The owner cannot be changed or removed.", "所有者创建了该团队。所有者无法被更改或移除。"],
  acsTeamRemoveAsk: ["Remove this person from the team? They will lose access to everything the team shares.", "确定将此成员移出团队吗？他们将无法再访问团队共享的任何内容。"],
  acsTeamLeaveAsk: ["Leave this team? You will lose access to everything the team shares.", "确定退出该团队吗？你将无法再访问团队共享的任何内容。"],
  acsTeamSaved: ["That change was saved.", "更改已保存。"],
  acsTeamRemoved: ["That person is no longer on this team.", "该成员已不在此团队中。"],
  acsTeamLeft: ["You have left this team.", "你已退出该团队。"],
  acsTeamEmpty: ["You are the only person on this team.", "目前团队中只有你一人。"],
  acsTeamNoneCreate: ["You are not on a team yet. You can create one here.", "你还没有加入任何团队。可以在这里创建一个。"],
  acsTeamName: ["Team name", "团队名称"],
  acsTeamCreate: ["Create team", "创建团队"],
  acsTeamCreated: ["Your team was created.", "你的团队已创建。"],
  acsTeamNoName: ["Name not set", "未设置名称"],
  acsTeamAccount: ["Account {short}", "账户 {short}"],
  acsTeamInvites: ["Invitations not yet accepted", "尚未接受的邀请"],
  acsTeamInviteBadge: ["Invited — not yet accepted", "已邀请，尚未接受"],
  acsTeamInviteExpires: ["Expires on {date}.", "{date} 到期。"],
  acsTeamTruncated: ["Showing the first {n} people; the full list is longer.", "仅显示前 {n} 位成员，完整名单更长。"],
  acsTeamInvitesFail: ["We could not read this team's invitations just now.", "暂时无法读取这个团队的邀请。"],
  acsTeamManyPanel: ["You are on {n} teams. This panel shows {name}.", "你在 {n} 个团队中。这里显示的是 {name}。"],
  acsTeamListTruncated: ["Not every team you belong to could be listed.", "你所属的团队未能全部列出。"],
  acsTeamJoinedUnread: ["Join date not read", "加入时间未读取"],
  acsTeamExpiryUnread: ["Expiry date not read", "到期时间未读取"],
  ...
  acsCurrentPw: ["Current password", "当前密码"],
  acsCurrentPwPh: ["Enter your current password", "输入你的当前密码"],
  acsCurrentPwRequired: ["Enter your current password first.", "请先输入当前密码。"],
  acsPwWrongCurrent: ["That is not your current password.", "当前密码不正确。"],
  acsPwSame: ["Your new password must be different from your current password.", "新密码不能与当前密码相同。"],
  acsPwRateLimited: ["Too many attempts. Please wait a few minutes and try again.", "尝试次数过多，请稍等几分钟后重试。"],
  acsPwNoPassword: ["You signed in without a password, so there is nothing to change here.", "你登录时未设置密码，因此这里没有可更改的内容。"],
  acsPwProviderUnknown: ["We could not tell how you signed in, so the password cannot be changed here.", "我们无法确认你的登录方式，因此这里无法更改密码。"],
  acsPwFailed: ["We could not change your password. Check your current password and try again.", "我们无法更改密码，请检查当前密码后重试。"],
  acsTeamLoading: ["Loading your team…", "正在加载团队信息…"],
  acsTeamUnavailable: ["We could not check your team right now.", "我们暂时无法查看你的团队信息。"],
  acsTeamNone: ["You are not on a team yet.", "你还没有加入任何团队。"],
  acsTeamOneOwner: ["You are the owner of {name}.", "你是“{name}”团队的所有者。"],
  acsTeamOneAdmin: ["You are an administrator of {name}.", "你是“{name}”团队的管理员。"],
  acsTeamOneMember: ["You are a member of {name}.", "你是“{name}”团队的成员。"],
  acsTeamMany: ["You are on {count} teams.", "你已加入 {count} 个团队。"],
  acsTeamRoleOwner: ["owner", "所有者"],
  acsTeamRoleAdmin: ["administrator", "管理员"],
  acsTeamRoleMember: ["member", "成员"],
  acsTeamUnnamed: ["an unnamed team", "未命名"],
  acsEdit: ["Edit", "编辑"],
  acsCancel: ["Cancel", "取消"],
  acsSave: ["Save", "保存"],
  ...
  shrSub: ["Lists you shared, and lists other people shared with you.", "你共享出去的清单，以及他人共享给你的清单。"],
  shrMineHead: ["Lists you shared", "你共享的清单"],
  shrYouShared: ["You shared this list.", "你已共享此清单。"],
  shrShareCta: ["Share a list", "共享清单"],
  shrPickList: ["Choose one of your lists", "选择你的一份清单"],
  shrAccountLabel: ["Their account ID", "对方的账户 ID"],
  shrAccountHint: ["Ask them to open Settings, then Account, and copy their User ID to you.", "请对方打开“设置”中的“账户”，复制其用户 ID 发给你。"],
  shrShareButton: ["Share, read only", "共享（仅可查看）"],
  shrReadOnlyNote: ["They can read this list. They cannot add, remove or rename anything in it.", "对方可以查看此清单，但不能在其中添加、删除或重命名任何内容。"],
  shrSharedWithAccount: ["Shared with the account ending {n}.", "已共享给账户尾号{n}。"],
  shrFullAccount: ["Full account ID", "完整账户 ID"],
  shrRevoke: ["Stop sharing", "停止共享"],
  shrRevoked: ["Sharing stopped. They can no longer open this list.", "已停止共享。对方不能再打开此清单。"],
  shrMineEmpty: ["You have not shared a list with anyone yet.", "你还没有向任何人共享清单。"],
  shrNoOwnLists: ["You have no lists to share yet.", "你还没有可以共享的清单。"],
  shrTheirsHead: ["Shared with you", "共享给你的"],
  shrSharedWithYouBy: ["Shared with you by another Mastermind account", "由另一个 Mastermind 账户共享给你"],
  shrReadOnlyBadge: ["Read only", "仅可查看"],
  shrOpenList: ["View list", "查看清单"],
  shrCloseList: ["Hide list", "收起清单"],
  shrSymbolOne: ["1 symbol", "1 个标的"],
  shrSymbolsMany: ["{n} symbols", "{n} 个标的"],
  shrTheirsEmpty: ["No one has shared a list with you yet.", "还没有人向你共享清单。"],
  shrNoLongerShared: ["This list is no longer shared with you.", "此清单已不再共享给你。"],
  shrListEmpty: ["This list has no symbols yet.", "这个清单还没有标的。"],
  shrUnavailable: ["Sharing is not set up on this server yet, so we cannot answer. Nothing was changed.", "此服务器尚未启用共享功能，因此我们无法作答。未更改任何内容。"],
  shrReadFailed: ["We could not read your shared lists just now.", "我们暂时无法读取你的共享清单。"],
  shrWriteFailed: ["We could not save that change.", "我们无法保存该更改。"],
  acsCopy: ["Copy", "复制"],
  ...
  peProprietaryBadge: ["Protected", "受保护"],
  peLockedAddTip: [
  ...
  peNeedsPro: ["Saving custom indicators requires Pro", "保存自定义指标需要 Pro"],
  ...
  peCompiling: ["Compiling {name}…", "正在编译 {name}…"],
  peErrorCount: ["{n} errors", "{n} 个错误"],
  peErrorCountOne: ["1 error", "1 个错误"],
  peInputsHeading: ["Inputs", "可调参数"],
  ...
  wsChooseCompany: ["Choose a company", "选择一个标的"],
  optionsCategoriesAria: ["Options categories", "期权类别"],
  optionsViewsAria: ["Options views", "期权子视图"],
  optionsStatisticsStatusAria: ["Statistics status", "统计页状态"],
  statOi: ["Open interest", "未平仓合约"],
  ohHoverStrike: ["Hover a strike for detail", "悬停查看行权价明细"],
  ohNoMinutes: ["Not enough intraday minutes to plot yet.", "盘中分钟数据不足，暂无法绘制。"],
  ...
  ohSessionCurrent: ["The regular-hours session is current — rows appear in new published source snapshots.", "当前常规交易时段仍在进行 — 达标成交进入新的源数据快照后显示。"],
  ohMarketClosedSnapshots: ["Market closed — showing the last session; new source snapshots resume after the next open.", "市场休市 — 显示上一交易时段；下次开盘后恢复新的源数据快照。"],
  ohHubTabs: ["Options Hub tabs", "期权工具选项卡"],
  ohFeedUnavailable: ["Feed unavailable — retrying…", "数据暂时不可用，请稍后重试。"],
  ohTapeUnreachable: ["Can’t reach the options tape stream, and nothing is cached for this session yet.", "无法连接期权盘口数据流，本时段尚无缓存数据。"],
  ohNoFilterMatch: ["No events match these filters.", "暂无符合条件的记录。"],
  ohSnapshotStalled: ["The source snapshot isn’t updating right now.", "源数据快照暂未刷新。"],
  ohMarketClosedLast: ["Market closed — showing the last session.", "市场休市 — 显示上一交易时段。"],
  ohNoUnusualFlow: ["No unusual options flow yet this session.", "本时段暂无异常期权流。"],
  ohLastCompletedSession: ["Showing the last completed session.", "显示上一完整交易时段。"],
  ohSnapshotQuiet: ["The latest source snapshot is quiet — qualifying prints appear when published.", "最新源数据快照暂时清淡 — 达标大单进入后显示。"],
  ohActivityLeaders: ["Activity Leaders", "活跃度领先"],
  ohVsPastYear: ["vs the past trading year", "对比过去一年"],
  ohTideUnavailable: ["Market tide unavailable.", "市场潮汐不可用。"],
  ohTideUnreachable: ["Can’t reach the intraday tide stream, and no series is cached for this session yet.", "无法连接盘中潮汐数据流，本时段尚无缓存序列。"],
  ohTideView: ["Tide view", "资金潮视图"],
  ohClickFilterTape: ["Click to filter Tape", "点击筛选逐笔"],
  ohNetCallBullish: ["Net call · bullish", "净认购 · 偏多"],
  ohNetPutBearish: ["Net put · bearish", "净认沽 · 偏空"],
  ohBarLengthPremium: ["Bar length equals the size of net directional premium", "条形长度等于净方向权利金规模"],
  ohNoResults: ["No results", "无结果"],
  ohNoFlowNames: ["No names have carried options flow this session yet.", "本时段尚无带期权流的标的。"],
  ohListRankedByPremium: ["The list is ranked by today’s net premium impact, and only names with flow this session appear.", "左侧按今日净权利金影响排序，仅列出本时段有期权流的标的。"],
  ohCallIv: ["Call implied volatility", "认购隐含波动率"],
  ohPutIv: ["Put implied volatility", "认沽隐含波动率"],
  ...
  ohFreshPositioning: ["Fresh positioning — volume above open interest", "新建仓位（成交量高于未平仓量）"],
  ohFreshFoot: ["Volume above open interest means today’s volume exceeds prior open interest — a fresh-positioning signal (not confirmed).", "成交量高于未平仓量表示当日成交量超过昨日未平仓量，为新开仓信号（非确认）。"],
  ohOiBuilds: ["Open interest builds", "未平仓增加"],
  ohAsOfPrevSession: ["as of previous session", "截至上一交易日"],
  ohDoiFoot: ["Open interest change is yesterday minus the day before. It does not say which way today’s flow went.", "未平仓变动是前两个交易日的差额，不代表当日方向。"],
  ohZeroDteFoot: ["Same-day expiry contracts. A high share may indicate intraday speculative activity.", "当日到期合约；高占比可能反映日内投机活动。"],
  ohHotContracts: ["Hot Contracts", "热门合约"],
  ohEtfDisplayOnly: ["ETF universe. Display only — not investment advice.", "ETF覆盖；仅供展示参考，非投资建议。"],
  ohNightlyBuild: ["Data builds nightly after market close", "数据每晚收盘后构建"],
  ohHeuristicFoot: ["Notability and direction labels are heuristic and approximate (~). Display only — not investment advice.", "标注与方向标签为启发式近似（~），仅供展示，不构成投资建议。"],
  ohOiYesterday: ["Open interest yesterday", "昨日未平仓"],
  ohOiChange: ["Open interest change", "未平仓变动"],

  // ---- B-PL-6 batch 2: chart chrome, login, academy, levels ----
  cmxSkipAnim: ["Skip animations", "跳过动画"],
  wtDiscoverTabs: ["Discover tabs", "发现选项卡"],
  opwPlans: ["Essential · Pro", "Essential · Pro"],
  isReadOnly: ["Built-in indicators are read-only. Edit a copy in the Pine Editor.", "内置指标为只读。可在 Pine 编辑器中编辑副本。"],
  lgWelcomeBack: ["Welcome back.", "欢迎回来。"],
  lgSignupPitch: ["Free access to charts; Pro unlocks custom + proprietary indicators.", "图表可免费使用；Pro 计划解锁自定义指标与专有指标。"],
  lgSignInTitle: ["Sign in to Mastermind", "登录 Mastermind"],
  lgCreateTitle: ["Create your account", "创建你的账户"],
  lgEmail: ["Email", "邮箱"],
  lgPassword: ["Password", "密码"],

  gpAcademy: ["Indicator Academy", "指标学院"],
  gpOnChart: ["On chart", "已在图表"],
  gpAddToChart: ["Add to chart", "添加到图表"],
  gpUpgrade: ["Upgrade", "升级解锁"],
  gpConfigure: ["Configure", "配置"],
  gpGuidesAria: ["Indicator guides", "指标指南"],
  gpLibrary: ["Guide library", "指南库"],
  gpLessons: ["lessons", "节课程"],
  gpSearchGuides: ["Search guides", "搜索指南"],
  gpSearchModules: ["Search indicator modules…", "搜索指标模块…"],
  gpClearSearch: ["Clear guide search", "清除指南搜索"],
  gpNoMatches: ["No matching guides.", "没有匹配的指南。"],
  gpGlance: ["At a glance", "快速了解"],
  gpWhatItShows: ["What it shows", "显示什么"],
  gpBestUsed: ["Best used for", "最佳用途"],
  gpGuardrail: ["When not to trust it", "使用边界"],
  gpContinue: ["Continue learning", "继续探索"],
  gpExploreRelated: ["Explore related indicators", "探索相关指标"],
  gpCalcSource: ["Calculation source", "计算来源"],
  gpPrevGuide: ["Previous guide", "上一指南"],
  gpNextGuide: ["Next guide", "下一指南"],
  gpOnThisGuide: ["On this guide", "本页内容"],
  gpSchemaNote: ["Labels, defaults, and ranges are generated from the live module schema used by Settings.", "名称、默认值与范围由设置面板正在使用的实时模块架构生成。"],
  gpSchemaAria: ["Current settings schema", "当前设置项"],
  gpAlertAvailable: ["Available in Alert Center", "可在提醒中心使用"],
  gpAlertNone: ["No Alert Center condition", "提醒中心暂不可用"],
  gpAlertLive: ["These conditions come from the live alert engine, not merely chart markers.", "这些条件来自实时提醒引擎，而不只是图表上的标记。"],
  gpAlertEmpty: ["This module has no creatable suite alert yet; the guide below notes any chart-only markers or events.", "此模块目前还没有可创建的套件提醒；下方指南会注明任何仅出现在图表上的标记或事件。"],
  gpNoInputs: ["This module has no inputs; it inherits the suite's live calculation context automatically.", "此模块没有输入项；它会自动继承套件的实时计算环境。"],

  lvPriorSession: ["· prior session", "· 上一交易日"],
  lvColorblindTitle: ["Colorblind palette — repaint sticky/slippery as blue/orange", "色盲配色——将粘滞/滑动改为蓝/橙"],
  lvColorblindOn: ["Blue / Orange", "蓝 / 橙"],
  lvColorblindOff: ["Colorblind", "色盲配色"],
  lvNoLevels: ["No levels for this root yet", "这个标的还没有档位"],
  lvReadingMap: ["Reading the gamma map…", "正在读取伽马地图…"],
  lvEmptyMap: ["No dealer-gamma levels to map for {ticker}. This root may not carry enough open interest yet — the board stays honest rather than draw a guess.", "没有可绘制的做市商伽马档位（{ticker}）。这个标的的未平仓量可能还不够——图会如实留空，而不是画一个猜测。"],
  lvTapLevel: ["Tap any level to read what it means.", "点任一档位，查看它代表什么。"],
  lvNamedLevels: ["Named levels", "具名档位"],
  lvReadingLegend: ["Reading the map", "如何读图"],
  lvSticky: ["Sticky", "粘滞"],
  lvStickyHint: ["— price tends to hold here.", "——价格往往在这里稳住。"],
  lvSlippery: ["Slippery", "滑动"],
  lvSlipperyHint: ["— price tends to slide here.", "——价格往往在这里滑走。"],
  lvBrightnessHint: ["Brighter, wider = more dealer gamma at that strike.", "更亮、更宽表示该行权价的做市商伽马更大。"],
  lvHonesty: ["Positioning, not prophecy. These are locations where dealer hedging concentrates — not forecasts. The dealer-sign convention is assumed, not measured. Open interest updates once a day, so this is a snapshot.", "这是仓位结构，不是预言。这些位置是做市商对冲最集中的地方，不是走势预测。做市商多空约定是假定的，不是实测的。未平仓合约每天更新一次，所以这是一张快照。"],
  lvLearnCta: ["New here? Learn the board →", "第一次看？先学怎么读图 →"],
  lvAsOf: ["as of", "截至"],
  lvLoading: ["Loading…", "加载中…"],
  lvConfluence: ["Confluence", "重叠区"],
  lvSpot: ["Spot", "现价"],
  lvTicker: ["Ticker", "代码"],
  lvConvention: ["Convention (assumed):", "约定（假定）："],

  llBack: ["← Back to the board", "← 返回档位图"],
  llHeroEyebrow: ["Levels · learn the board", "档位图 · 学习看盘"],
  llHeroTitle: ["The gamma weather map, in six reads", "伽马天气图，分六步读"],
  llHeroSub: ["The Levels board maps where dealer hedging concentrates on a stock's options — the terrain that tends to make price hold or slide. It is display-only context: positioning, not prophecy. Here is how to read it.", "档位图标出一只股票期权上做市商对冲最集中的位置——这些地形往往会让价格稳住或滑走。它只是展示用的背景：是仓位结构，不是预言。下面说明怎么读。"],
  llOpenBoard: ["Open the Levels board →", "打开档位图 →"],
  llFootNote: ["Display-only market structure. Not investment advice.", "仅展示市场结构。不构成投资建议。"],

  ll1eyebrow: ["The idea", "核心想法"],
  ll1title: ["Why price gets sticky or slippery", "价格为什么会变黏或变滑"],
  ll1a: ["Big options positions have to be hedged, and the people on the other side of them buy and sell the underlying stock to stay balanced as it moves. When that hedging ", "大型期权仓位必须对冲。对冲的另一方会随着标的股票涨跌买入或卖出，以保持仓位平衡。当这种对冲"],
  ll1leans: ["leans against", "逆势而为"],
  ll1b: [" the move — selling into strength, buying into weakness — price tends to slow down and hold. We call that", "——上涨时卖出、下跌时买入——价格往往会放慢并稳住。我们称之为"],
  ll1sticky: [" sticky", "粘滞"],
  ll1c: [". When the hedging ", "。当对冲"],
  ll1chases: ["chases", "顺势而为"],
  ll1d: [" the move instead — buying higher, selling lower — price tends to speed up and slide. We call that", "——越涨越买、越跌越卖——价格往往会加速滑动。我们称之为"],
  ll1slippery: [" slippery", "滑动"],
  ll1e: [". The map colors every strike by which kind of terrain it is.", "。地图按地形种类给每个行权价上色。"],

  ll2eyebrow: ["The anchor", "锚点"],
  ll2title: ["The Keystone", "关键位（Keystone）"],
  ll2a: ["One strike usually carries more dealer hedging than any other. That is the", "通常有一个行权价承担的做市商对冲最多。那就是"],
  ll2keystone: [" Keystone", "关键位（Keystone）"],
  ll2b: [" — the day's biggest magnet. Price is often drawn toward it and tends to settle near it, because that is where hedging pressure is heaviest. It is the first thing to find on the map, and everything else is read relative to it. Brighter and wider means more weight; the Keystone is the brightest rung by definition.", "——当天最大的磁铁。价格常被吸过去，并倾向于在附近停留，因为那里的对冲压力最重。看图时先找它，其余位置都相对它来读。更亮、更宽表示分量更大；关键位按定义是最亮的一档。"],

  ll3eyebrow: ["The edges", "上下沿"],
  ll3title: ["Ceiling vs. Floor — and why a Floor isn't support", "天花板与地板位——以及地板位为什么不是支撑"],
  ll3ceiling: ["The Ceiling", "天花板"],
  ll3b: [" is the heavy strike above price where hedging tends to lean against a push higher — a spot where upside can stall. The ", "是价格上方对冲最重的行权价，对冲往往会挡住继续上涨——上攻可能在这里停住。"],
  ll3floor: ["Floor", "地板位"],
  ll3c: [" is the heavy strike below price. Here is the honest part: a Floor is not the same as support. It marks where hedging turns ", "是价格下方对冲最重的行权价。需要诚实说明：地板位并不等于支撑。它标出对冲转为"],
  ll3slip: ["slippery", "滑动"],
  ll3d: [", so a move down through it can pick up speed rather than get cushioned. Treat the Floor as a place where the terrain changes, not a place that catches you.", "的位置，因此跌破后往往加速，而不是被托住。把地板位当成地形改变的地方，而不是会接住你的地方。"],

  ll4eyebrow: ["The boundary", "分界"],
  ll4title: ["The Flip — calm above, wild below", "翻转位——上方偏稳，下方偏乱"],
  ll4flip: ["The Flip", "翻转位"],
  ll4b: [" is the price where the net hedging effect crosses from one kind to the other. Above it the tape tends to run ", "是净对冲效果从一种切换到另一种的价格。在它上方，行情往往"],
  ll4calm: ["calm", "平稳"],
  ll4c: [" (sticky terrain, moves fade). Below it the tape tends to run ", "（粘滞地形，波动容易消退）。在它下方，行情往往"],
  ll4wild: ["wild", "剧烈"],
  ll4d: [" (slippery terrain, moves extend). It is a boundary line on the map, not a level with weight of its own — which is why it shows as a dashed line rather than a colored rung.", "（滑动地形，波动容易延伸）。它是地图上的分界线，本身没有重量——所以画成虚线，而不是彩色档。"],

  ll5eyebrow: ["The texture", "疏密"],
  ll5title: ["Clusters and Voids", "密集区与真空区"],
  ll5cluster: ["A Cluster", "密集区"],
  ll5b: [" is a secondary magnet — a strike stacked with enough hedging to act like a smaller Keystone. A ", "是次级磁铁——堆了足够对冲的行权价，作用像一枚较小的关键位。"],
  ll5void: ["Void", "真空区"],
  ll5c: [" is the opposite: a stretch of strikes with almost no dealer gamma. Because there is little hedging friction in a Void, price can travel across that band quickly once it enters — think of it as thin air between rungs. Clusters are where the map is dense; Voids are where it is empty.", "则相反：一段几乎没有做市商伽马的行权价。真空区里对冲摩擦力很小，价格一旦进入可以很快穿过——可以想成档位之间的稀薄空气。密集区是图上密的地方；真空区是空的地方。"],

  ll6eyebrow: ["The fine print", "使用边界"],
  ll6title: ["Positioning, not prophecy", "仓位结构，不是预言"],
  ll6a: ["This board shows ", "这张图展示的是"],
  ll6loc: ["locations where dealer hedging concentrates", "做市商对冲集中的位置"],
  ll6b: [" — it does not predict direction or tell you what to do. Three honest limits worth keeping in mind: the underlying open-interest data ", "——它不预测方向，也不告诉你该怎么做。有三条需要记住的诚实限制：底层未平仓数据"],
  ll6daily: ["updates once a day", "每天只更新一次"],
