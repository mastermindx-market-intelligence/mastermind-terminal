...
export const LEX: Record<string, [string, string]> = {
  ...
  mtfTip: ["Precision MTF — four timeframes selected from the active chart horizon", "精确多周期 — 根据当前图表周期选择四个时间层级"],
  mtfUnavailableTip: ["Precision MTF is unavailable for this market and timeframe", "此市场和周期暂不支持精确多周期"],
