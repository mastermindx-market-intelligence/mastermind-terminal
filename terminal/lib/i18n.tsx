...
export const LEX: Record<string, [string, string]> = {
  ...
  lvReadingMap: ["Reading the gamma map…", "正在读取 Gamma 地图…"],
  lvEmptyMap: ["No dealer-gamma levels to map for {ticker}. This root may not carry enough open interest yet — the board stays honest rather than draw a guess.", "没有可绘制的做市商 Gamma 档位（{ticker}）。这个标的的未平仓量可能还不够——图会如实留空，而不是画一个猜测。"],
  ...
  lvBrightnessHint: ["Brighter, wider = more dealer gamma at that strike.", "更亮、更宽表示该行权价的做市商 Gamma 更大。"],
  ...
  llHeroTitle: ["The gamma weather map, in six reads", "Gamma 天气图，分六步读"],
