...
export default defineConfig({
  ...
  // sample, not a fresh one. Retries remain diagnostic attempts only: a test that
  // passes after an earlier failure must keep the required CI check red until a
  // separately reviewed infrastructure-transient classifier exists.
