...
export const LEX: Record<string, [string, string]> = {
  ...
  acsTeamNone: ["You are not on a team yet. You can create one here.", "你还没有加入任何团队。可以在这里创建一个。"],
  ...
  acsTeamMany: ["You are on {n} teams. This panel shows {name}.", "你在 {n} 个团队中。这里显示的是 {name}。"],
