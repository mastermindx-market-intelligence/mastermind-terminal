...
export const LEX: Record<string, [string, string]> = {
  ...
  drawingPlanR: ["Plan", "计划"],
  drawingRemainingR: ["Left", "剩余"],
  drawingAtTarget: ["At/beyond target", "已至目标一侧"],
  drawingBeyondStop: ["At/beyond stop", "已至止损一侧"],
  drawingGeometryUnavailable: ["Geometry unavailable", "几何不可用"],
  drawingReferenceUnavailable: ["Reference unavailable", "参考价不可用"],
  drawingLastChartPrice: ["Last chart price", "图表末价"],
  drawingBeforeCosts: ["before costs", "未计费用"],
  drawingPlanningOnly: ["Planning geometry only; not an actual fill, live quote, or trade outcome.", "仅为计划几何；并非实际成交、实时报价或交易结果。"],
